class ClaimData {
  ...
  factory ClaimData.fromJson(Map<String, dynamic> json) {
    return ClaimData(
      ...
      claimType: json['data']['claim_type'],
      approvalType: json['data']['approval_type'],
      ...
      hierarchyNodes: (json['data']['hierachy_nodes'] as List<dynamic>?)
          ...
          .toList(),
      productHierarchyNodes: Map<String, String>.from(
          json['data']['product_hierarchy_nodes'] ?? {}),
      skuHierarchyNodes:
          Map<String, String>.from(json['data']['sku_hierarchy_nodes'] ?? {}),
      ...
      productHierarchyLevels:
          (json['data']['product_hierarchy_levels'] as List<dynamic>?)
              ...
              .toList(),
      highestProductHierarchyLevelRank: json['data']
