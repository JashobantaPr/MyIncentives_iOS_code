...
class TypeCViewDetailsPendingforapprovalScreen
    extends GetWidget<TypeCViewDetailsPendingforapprovalController> {
  const TypeCViewDetailsPendingforapprovalScreen({super.key});
