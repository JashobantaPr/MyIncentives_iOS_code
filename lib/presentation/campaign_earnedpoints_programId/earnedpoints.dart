...
class CampaignEarnedPointsScreen1
    extends GetWidget<CampaignEarnedPointsController1> {
  const CampaignEarnedPointsScreen1({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Earned Points: ${Get.arguments[0]['calculatedpayout'] ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
                ...
                Obx(() {
                  if (controller.isLoading.value) {
                    ...
                    return const Center(child: Text('No earned points'));
                  } else {
