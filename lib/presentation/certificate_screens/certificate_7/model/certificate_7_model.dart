...
class Certificate {
  ...
  factory Certificate.fromJson(Map<String, dynamic> json) {
    return Certificate(
      ...
      certificateAllotedCertificateCount: json['certificate_alloted_certificate_count'],
      ...
      certificateDetailCompanyLogoUrl: json['certificate_detail_company_logo_url'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'certificate_alloted_certificate_count': certificateAllotedCertificateCount,
