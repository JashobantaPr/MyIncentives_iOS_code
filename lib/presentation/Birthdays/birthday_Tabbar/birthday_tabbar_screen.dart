...
import 'package:incentivesgit/presentation/Birthdays/Birthday_1/birthday1_screen.dart';
import 'package:incentivesgit/presentation/Birthdays/Birthday_2/Birthday_2_screen.dart';
import 'package:incentivesgit/presentation/Birthdays/Birthday_3/upcomingbirthday_screen.dart';
...
class BirthdayTabBarScreens extends StatelessWidget {
  ...
  BirthdayTabBarScreens({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BirthDayTabBarController>(
      builder: (controller) {
