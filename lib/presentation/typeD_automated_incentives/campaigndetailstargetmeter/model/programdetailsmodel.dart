  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      users: (json['users'] != null && json['users'] != "")
          ? Map<String, User>.from(
              (json['users'] as Map<String, dynamic>).map(
                (key, value) => MapEntry(key, User.fromJson(value)),
              ),
            )
          : null,
      userIds: (json['user_ids'] != null && json['user_ids'] != "")
          ? (json['user_ids'] as String).split(',')
          : null,
      programDetails:
          (json['program_details'] != null && json['program_details'] != "")
              ? List<ProgramDetails>.from(json['program_details']
                  .map((program) => ProgramDetails.fromJson(program)))
              : null,
      programOwners:
          (json['program_owners'] != null && json['program_owners'] != "")
              ? List<ProgramOwner>.from(json['program_owners']
                  .map((owner) => ProgramOwner.fromJson(owner)))
              : null,
      programCoOwners:
          (json['program_co_owners'] != null && json['program_co_owners'] != "")
              ? List<ProgramCoOwner>.from(json['program_co_owners']
                  .map((coOwner) => ProgramCoOwner.fromJson(coOwner)))
              : null,
      programReportOwners: (json['program_report_owners'] != null &&
              json['program_report_owners'] != "")
          ? List<ProgramReportOwner>.from(json['program_report_owners']
              .map((reportOwner) => ProgramReportOwner.fromJson(reportOwner)))
          : null,
      programPointOwners: (json['program_point_owners'] != null &&
              json['program_point_owners'] != "")
          ? List<ProgramPointOwner>.from(json['program_point_owners']
              .map((pointOwner) => ProgramPointOwner.fromJson(pointOwner)))
          : null,
      sponsorId: (json['sponsor_id'] != null && json['sponsor_id'] != "")
