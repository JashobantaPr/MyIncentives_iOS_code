...
class CampaignEarnedPointsScreen
    extends GetWidget<CampaignEarnedePointsController> {
  const CampaignEarnedPointsScreen({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Earned Points: ${controller.earnedpoints ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
