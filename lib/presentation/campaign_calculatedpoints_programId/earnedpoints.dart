...
class CampaignCalculatedPointsScreen
    extends GetWidget<CampaignCalculatedPointsController1> {
  const CampaignCalculatedPointsScreen({super.key});
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5.w),
                      Text(
                        'Total Calculated Points: ${Get.arguments[0]['calculatedpayout'] ?? '0'}',
                        style: TextStyle(
                            fontSize: 16.sp,
