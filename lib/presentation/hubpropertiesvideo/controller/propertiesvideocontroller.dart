...
import 'package:incentivesgit/presentation/hubpropertiesvideo/service/propertiesvideonservice.dart';

class HubPropertiesVideoController extends GetxController {
  ...
  void fetchHubProperties() async {
    try {
      var claimDetails = await HubPropetiesVideoService().hubVideoproperties();
