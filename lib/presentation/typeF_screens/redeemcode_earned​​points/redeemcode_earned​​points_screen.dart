...
class RedeemCodeEarnedPointsScreen
    extends GetWidget<RedeemCodeEarnedPointsController> {
  const RedeemCodeEarnedPointsScreen({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Expired Point: 10,000',
                      // ${controller.expiredpoints ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
